      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-card rounded-2xl border border-border p-8 shadow-card">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionTrigger className="text-left text-lg font-semibold text-foreground hover:text-[#f47757] py-4">
                  {faq.question}
                </AccordionTrigger>
        ...
        <div className="text-center mt-12">
          ...
          <Button
            variant="outline"
            size="lg"
            className="rounded-full cursor-pointer border-[hsl(var(--brand-pink))]/40"
          >
            联系客服
          </Button>
        </div>

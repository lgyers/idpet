  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900 mb-4">我的配额</h1>
          <p className="text-xl text-gray-600">查看和管理你的生成配额</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold text-gray-900">配额概览</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-sm text-gray-600 mt-1">剩余次数</div>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <div className="text-3xl font-bold text-gray-900">{quotaInfo.quotaMonth}</div>
                  <div className="text-sm text-gray-600 mt-1">月度总额</div>
                </div>
              </div>
              ...
              {isLowQuota && (
                <div className={`p-4 rounded-lg ${isOutOfQuota ? "bg-red-50" : "bg-yellow-50"}`}>
                  <p className={`text-sm ${isOutOfQuota ? "text-red-800" : "text-yellow-800"}`}>
                    {isOutOfQuota
                      ? "你的配额已用完，请升级套餐以继续生成"
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl p-8"
          >
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">套餐升级</h2>
            ...
            <div className="space-y-4">
              <div className="border-2 border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">适合偶尔使用</p>
                  </div>
                  {quotaInfo.tier === "free" && (
                    <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">当前</span>
                  )}
                </div>
                <div className="text-2xl font-bold text-gray-900 mb-2">¥0<span className="text-sm font-normal text-gray-600">/月</span></div>
              ...
              <div className="border-2 border-blue-500 rounded-lg p-4 bg-blue-50">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">适合经常使用</p>
                  </div>
                  {quotaInfo.tier === "basic" && (
                    <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">当前</span>
                  )}
                </div>
                <div className="text-2xl font-bold text-blue-600 mb-2">¥29<span className="text-sm font-normal text-gray-600">/月</span></div>
                <ul className="space-y-1 text-sm text-gray-600 mb-4">
                ...
                {quotaInfo.tier !== "basic" ? (
                  ...
                  <button className="w-full px-4 py-2 border border-blue-300 text-blue-700 rounded-lg hover:bg-blue-100">
                    管理订阅
                  </button>
                )}
              </div>
              ...
              <div className="border-2 border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="font-semibold text-gray-900">专业版</h3>
                    <p className="text-sm text-gray-600">适合专业用户</p>
                  </div>
                  {quotaInfo.tier === "pro" && (
                    <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">当前</span>
                  )}
                </div>
                <div className="text-2xl font-bold text-gray-900 mb-2">¥99<span className="text-sm font-normal text-gray-600">/月</span></div>
                <ul className="space-y-1 text-sm text-gray-600 mb-4">

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900 mb-4">生成历史</h1>
          <p className="text-xl text-gray-600">查看和管理你的所有生成记录</p>
        </motion.div>
        ...
        {generations.length === 0 ? (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">还没有生成记录</h3>
            <p className="text-gray-600 mb-6">开始创建你的第一张宠物创意照片吧</p>
            <button
            ...
            >
              <AnimatePresence mode="wait">
                {selectedGeneration ? (
                  ...
                  >
                    <h2 className="text-xl font-semibold text-gray-900 mb-6">生成详情</h2>

                    <div className="space-y-6">
                      <div>
                        <h3 className="text-sm font-medium text-gray-700 mb-3">原始照片</h3>
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-gray-700 mb-2">模板</h3>
                        <p className="text-gray-900">{selectedGeneration.templateName}</p>
                      </div>

                      <div>
                        <h3 className="text-sm font-medium text-gray-700 mb-2">生成时间</h3>
                        <p className="text-gray-900">{formatDate(selectedGeneration.createdAt)}</p>
                      </div>
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">选择记录查看详情</h3>
                    <p className="text-gray-600">点击左侧的生成记录查看详细信息</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
